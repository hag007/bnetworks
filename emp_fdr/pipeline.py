...
if __name__=="__main__":
    ...
    override_permutations_param = "--override_permutations_param {}".format(override_permutations)
    for cur_ds in datasets:
        for cur_alg in algos:
            ...
            execute_stage(py_script, [datasets_param, algos_param, prefix_param])

            py_script = "fdr_consistent_terms.py"
            execute_stage(py_script, [datasets_param, algos_param, prefix_param, pf_param, n_iteration_param, n_total_samples_param, n_dist_samples_param])
