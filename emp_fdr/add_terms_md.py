...
if __name__=="__main__":
    ...
    for cur_ds in datasets:
        for cur_alg in algos:
            ...
            results=utils.add_GO_terms_metadata_agg.main(cur_ds, cur_alg, n_permutations, csv_file_name=os.path.join(constants.OUTPUT_GLOBAL_DIR, "emp_fdr", "MAX/emp_diff_{dataset}_{algo}.tsv"), prefix=prefix)
            if results is None:
                continue
