...
def leave_significant_modules(G_original, G_modularity):
    ...
    fdr_bh_results = fdrcorrection0(sig_scores, alpha=0.5, method='indep',
                                    is_sorted=False)
...
def main(dataset_name="GE_HC12", score_file_name="/media/hag007/Data/bnet/datasets/GE_HC12/output/ge_list.txt", network_file_name="dip.sif", modules_file_name=os.path.join(constants.OUTPUT_GLOBAL_DIR, "modules.txt")):
    ...
    G_modularity, optimized_connected_components = leave_significant_modules(G, G_modularity)
