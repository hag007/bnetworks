...
dataset_folder=/specific/netapp5/gaga/hagailevi/evaluation/bnet/datasets/GE_random_SOC_netbox_11
...
echo /specific/netapp5/gaga/hagailevi/evaluation/bnetworks_alg/netbox/conf_0.170470030872.props

python $NETBOX_HOME/bin/netAnalyze.py /specific/netapp5/gaga/hagailevi/evaluation/bnetworks_alg/netbox/conf_0.170470030872.props
