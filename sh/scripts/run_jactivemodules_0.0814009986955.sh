...
dataset_folder=/media/hag007/Data/bnet/datasets/GWAS_scz_updated
...
echo /media/hag007/Data/bnet/datasets/GWAS_scz_updated/data/score.tsv


java -jar $algo_dir/jactivemodules.jar \
                                 /media/hag007/Data/bnet/networks/dip.sif \
                                 /media/hag007/Data/bnet/datasets/GWAS_scz_updated/data/score.tsv \
                                 $is_greedy \
                                 $num_of_modules \
                                 $overlap_threshold \
                                 /media/hag007/Data/bnet/datasets/GWAS_scz_updated/output/jactivemodules_greedy_results.txt
