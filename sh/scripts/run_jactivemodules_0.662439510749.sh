...
dataset_folder=/media/hag007/Data/bnet/datasets/GE_SHEZH_1
...
echo /media/hag007/Data/bnet/datasets/GE_SHEZH_1/cache/deg_edger.tsv


java -jar $algo_dir/jactivemodules.jar \
                                 /media/hag007/Data/bnet/networks/dip.sif \
                                 /media/hag007/Data/bnet/datasets/GE_SHEZH_1/cache/deg_edger.tsv \
                                 $is_greedy \
                                 $num_of_modules \
                                 $overlap_threshold \
                                 /media/hag007/Data/bnet/datasets/GE_SHEZH_1/output/jactivemodules_greedy_results.txt
