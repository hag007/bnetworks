...
dataset_folder=/specific/netapp5/gaga/hagailevi/evaluation/bnet/datasets/GE_random_SOC_netbox_25
...
echo /specific/netapp5/gaga/hagailevi/evaluation/bnetworks_alg/netbox/conf_0.675716703192.props

python $NETBOX_HOME/bin/netAnalyze.py /specific/netapp5/gaga/hagailevi/evaluation/bnetworks_alg/netbox/conf_0.675716703192.props
