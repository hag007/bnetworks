...
dataset_folder=/home/ec2-user/bnet/datasets/user1541684459.48
...
echo /home/ec2-user/bnet/datasets/user1541684459.48/cache/deg_edger.tsv


java -jar $algo_dir/jactivemodules.jar \
                                 $networks_folder/dip.sif \
                                 /home/ec2-user/bnet/datasets/user1541684459.48/cache/deg_edger.tsv \
                                 $is_greedy \
                                 /home/ec2-user/bnet/datasets/user1541684459.48/output/jactivemodules_greedy_results.txt
