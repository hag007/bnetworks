...
dataset_folder=/media/hag007/Data/bnet/datasets/GE_TNFa_2
...
echo /media/hag007/Data/bnet/datasets/GE_TNFa_2/cache/deg_edger.tsv


java -jar $algo_dir/jactivemodules.jar \
                                 /media/hag007/Data/bnet/networks/dip.sif \
                                 /media/hag007/Data/bnet/datasets/GE_TNFa_2/cache/deg_edger.tsv \
                                 $is_greedy \
                                 $num_of_modules \
                                 $overlap_threshold \
                                 /media/hag007/Data/bnet/datasets/GE_TNFa_2/output/jactivemodules_greedy_results.txt
