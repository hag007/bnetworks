...
dataset_folder=/specific/netapp5/gaga/hagailevi/evaluation/bnet/datasets/GE_random_SOC_345
...
echo /specific/netapp5/gaga/hagailevi/evaluation/bnet/datasets/GE_random_SOC_345/cache/deg_edger.tsv


java -jar $algo_dir/jactivemodules.jar \
                                 /specific/netapp5/gaga/hagailevi/evaluation/bnet/networks/dip.sif \
                                 /specific/netapp5/gaga/hagailevi/evaluation/bnet/datasets/GE_random_SOC_345/cache/deg_edger.tsv \
                                 $is_greedy \
                                 $num_of_modules \
                                 $overlap_threshold \
                                 /specific/netapp5/gaga/hagailevi/evaluation/bnet/datasets/GE_random_SOC_345/output/jactivemodules_greedy_results.txt
