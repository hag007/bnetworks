...
dataset_folder=/media/hag007/Data/bnet/datasets/GE_SOC
...
echo /media/hag007/Data/bnet/datasets/GE_SOC/cache/deg_edger.tsv


java -jar $algo_dir/jactivemodules.jar \
                                 /media/hag007/Data/bnet/networks/dip \
                                 /media/hag007/Data/bnet/datasets/GE_SOC/cache/deg_edger.tsv \
                                 $is_greedy \
                                 $num_of_modules \
                                 $overlap_threshold \
                                 /media/hag007/Data/bnet/datasets/GE_SOC/output/jactivemodules_greedy_results.txt
