...
echo /specific/netapp5/gaga/hagailevi/evaluation/bnetworks_alg/netbox/conf_0.699206411278.props

python $NETBOX_HOME/bin/netAnalyze.py /specific/netapp5/gaga/hagailevi/evaluation/bnetworks_alg/netbox/conf_0.699206411278.props
