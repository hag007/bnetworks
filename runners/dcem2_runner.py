...
from implementations.dcem2 import main as dcem_main
...
if __name__ == "__main__":
    ds=["PASCAL_SUM_Breast_Cancer.G50"] # "PASCAL_SUM_Breast_Cancer.G50" "PASCAL_SUM_Type_2_Diabetes.G50", "PASCAL_SUM_Breast_Cancer.G50", "PASCAL_SUM_Crohns_Disease.G50", "PASCAL_SUM_Schizophrenia.G50", "PASCAL_SUM_Triglycerides.G50"]
    # ds=["GE_HC12", "GE_ROR_1","GE_TNFa_2","GE_SHERA","GE_SHEZH_1,GE_ERS_1,GE_IEM"]
    for cur in ds:
