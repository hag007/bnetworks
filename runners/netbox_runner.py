...
def init_specific_params(score_file_name, dest_algo_dir, dataset_name):
    ...
    ge_list_file_name = os.path.join(constants.DATASETS_DIR, dataset_name, "output", "ge_list.txt")
