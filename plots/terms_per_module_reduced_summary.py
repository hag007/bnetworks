...
def plot_modules_ehr_summary(prefix,datasets,algos, base_folder, terms_file_name_format):
    ...
    ax.set_ylabel("solution\n(alg-dataset combination)", size=25)
...
if __name__ == "__main__":
    ...
    prefix = "GE"
    algos = ["jactivemodules_greedy", "jactivemodules_sa", "bionet", "netbox", "keypathwayminer_INES_GREEDY"] # "dcem", "dcem2", "dcem3", "dcem4", "my_netbox_td"
    ...
    prefix = "PASCAL_SUM"
    algos = ["jactivemodules_greedy", "jactivemodules_sa", "bionet", "netbox"] # "dcem", "dcem2", "dcem3", "dcem4", "my_netbox_td"
